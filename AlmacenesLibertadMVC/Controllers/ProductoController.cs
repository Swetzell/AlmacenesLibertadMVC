...
namespace AlmacenesLibertadMVC.Controllers
{
    public class ProductoController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "codpro,nompro,despro,prepro,canpro,estpro,codcat,codmar")] producto producto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "codpro,nompro,despro,prepro,canpro,estpro,codcat,codmar")] producto producto)
        {
            if (ModelState.IsValid)
            {
